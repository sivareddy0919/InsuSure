    ...
    fetch(loginApiUrl, {
      ...
      .then(data => {
        ...
        if (data.status === 'success') {
          ...
          navigation.navigate('Patientdashboard', { username }); // Navigate to the Patientdashboard screen with username parameter
        } else {
...
const styles = StyleSheet.create({
  ...
  topContainer: {
    ...
    height: windowHeight * 0.13, // Adjust height as needed
    width: '100%',
